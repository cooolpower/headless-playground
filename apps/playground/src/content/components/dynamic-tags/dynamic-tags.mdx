...
`style`과 `styles` prop을 사용하여 컴포넌트와 내부 요소들의 스타일을 직접 제어할 수 있습니다.

<Playground preview={<DemoDynamicTagsStyles />} />
...
| size         | 입력 필드 크기                | `'small' \| 'medium' \| 'large' \| 'custom'`                                  | `'medium'`            |
| injectStyles | 기본 스타일 주입 여부         | `boolean`                                                                     | `true`                |
| style        | 루트 요소 스타일              | `React.CSSProperties`                                                         | -                     |
| styles       | 내부 요소별 스타일            | `object`                                                                      | -                     |
